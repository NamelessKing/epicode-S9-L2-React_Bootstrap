...
class SingleBook extends Component {
  ...
  handleClick = () => {
    this.setState(
      ...
      () => {
        console.log("Selected è ora:", this.state.selected);
      }
    );
  };
  ...
  render() {
    ...
    return (
      // ⭐ CAMBIAMENTO: Wrappare tutto in un div invece di Fragment
      <div>
        {/* Card del libro */}
        <Card
          className="h-100"
        ...
        {/* ⭐ CommentArea - Ora dentro lo stesso div */}
